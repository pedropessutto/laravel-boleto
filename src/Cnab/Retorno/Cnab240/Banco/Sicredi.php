    ...
    protected function processarDetalhe(array $detalhe)
    {
        ...
        if ($this->getSegmentType($detalhe) == 'U') {
            $d->setValorMulta(Util::nFloat($this->rem(18, 32, $detalhe) / 100, 2, false))
                ...
                // comentado porque estava sobrescrevendo a tarifa capturada no segmento T
                //->setValorTarifa($d->getValorRecebido() - Util::nFloat($this->rem(93, 107, $detalhe)/100, 2, false))                ->setDataOcorrencia($this->rem(138, 145, $detalhe))
